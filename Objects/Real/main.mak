...
export WIN32_AS_PROJECT_PATH := "C:\Users\admin\Downloads\ezyZip\LAB1"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation42\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation42\AS45\AS\VC"
export WIN32_AS_TEMP_PATH := "C:\Users\admin\Downloads\ezyZip\LAB1\Temp"
export WIN32_AS_BINARIES_PATH := "C:\Users\admin\Downloads\ezyZip\LAB1\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/LAB1.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Build'   
